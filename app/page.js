...
import {
  Volume2, Sun, Users, MapPin, Clock, Share2,
  Brain, Heart, Zap, Coffee, ArrowRight, Sparkles,
  CheckCircle2
} from 'lucide-react';
    ...
    <div style={{ flex: 1 }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: '14px', color: '#5a7a52', fontWeight: '500' }}>
        ...
        <p style={{
          ...
          Discover sensory-friendly restaurants and cafes.
          AI-powered comfort scores help you find venues where you can actually relax.
        </p>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={label} style={{
                ...
                <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#3d3d3d', marginBottom: '4px' }}>
                  {label}
                </h3>
          ...
          <div style={{
            ...
            {[
              ...
              <div key={question} style={{
                ...
                <span style={{ fontSize: '16px', color: '#6b6b6b' }}>{question}</span>
              </div>
            ))}
          </div>
          <p style={{
          ...
          <div style={{
            ...
            {[
              ...
              <div key={step} style={{
                ...
                <div style={{ fontSize: '40px', marginBottom: '16px', marginTop: '8px' }}>{icon}</div>
                <h3 style={{ fontSize: '20px', fontWeight: '600', color: '#3d3d3d', marginBottom: '8px' }}>
                  {title}
                </h3>
                <p style={{ fontSize: '15px', color: '#6b6b6b', lineHeight: '1.6' }}>{desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{
          ...
          {[
            ...
            <div key={title} style={{
              ...
              <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#3d3d3d', marginBottom: '8px' }}>
                {title}
              </h3>
              <p style={{ fontSize: '14px', color: '#6b6b6b', lineHeight: '1.6' }}>{desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section style={{
        ...
        <p style={{ fontSize: '13px', color: '#c9c9c9', marginTop: '8px' }}>
